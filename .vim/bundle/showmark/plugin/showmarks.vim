...
if !exists('g:showmarks_auto_enable')  | let g:showmarks_auto_enable  = 0  | endif   "added by Andy Zeng 
...
""hi ShowMarksHLl ctermfg=Magenta  ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
""hi ShowMarksHLu ctermfg=blue   ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
hi ShowMarksHLo ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=lightblue gui=bold
hi ShowMarksHLm ctermfg=darkblue ctermbg=blue cterm=bold guifg=blue guibg=lightblue gui=bold
hi ShowMarksHLu ctermbg=Yellow ctermfg=Black  guibg=Yellow guifg=Black
hi ShowMarksHLl ctermbg=Magenta ctermfg=Black guibg=Magenta guifg=Black
